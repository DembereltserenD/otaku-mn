  ...
  return (
    ...
    >
      <View style={styles.modalHeader}>
        <Typography variant="h2">Add New Anime</Typography>
      ...
      <View style={styles.formField}>
        ...
        <TextInput
          ...
          placeholderTextColor={colors.textSecondary}
          value={newAnime.cover_image_url}
      ...
      <View style={styles.formField}>
        ...
        <TextInput
          ...
          placeholderTextColor={colors.textSecondary}
          value={newAnime.release_year?.toString()}
          ...
          {['ongoing', 'completed', 'upcoming'].map(status => (
            ...
            >
              <Typography
                ...
                color={newAnime.status === status ? colors.primary : colors.text}
              >
